...
// WORLD SCALE
// ==================================================
// Three.js 内部の 1 unit を何メートルとして扱うか。
// 以前: 1 unit = 1 m
// 現在: 1 unit = 0.5 m
//
// 物理シミュレーション内部の数値は変更しない。
...
// IMPORTANT:
//
// CSS の cursor:none は一切使用しない。
// カーソルを隠す処理はブラウザ標準の
// Pointer Lock に完全に任せる。
//
// Esc による解除についてもブラウザ標準を使用。
//
// ==================================================
let pointerLocked =
  false;
